...
4. Click **Action** and select **Update Application**.
    ...
    ![Resubmissions tab](../assets/images/resubmissions-tab.png)
...
1. Review the comments and remarks TCAA has provided.
    ...
    ![Resubmission comments and remarks](../assets/images/resubmission-comments-remarks.png)

2. Click **Next**.
3. Update the application as required, completing all applicable sections.

    ![Application Details step during resubmission](../assets/images/resubmission-application-details-step.png)

4. Click **Next**, then check **Accept Declaration**.
5. Click **Resubmit**.

    ![Declaration step — Resubmit](../assets/images/resubmission-declaration-resubmit.png)
...
1. On the Application Details page, select **Go Perform Task**.
    ...
    ![Checklist returned — go perform the task](../assets/images/checklist-returned-go-perform-task.png)
...
3. Click **Resubmit** next to the relevant checklist item.
    ...
    ![Checklist tab — Returned items](../assets/images/checklist-tab-returned.png)
...
6. After updating all required documents, click **Resubmit Form**.
    ...
    ![Upload revised document and Resubmit Form](../assets/images/checklist-upload-revised-document.png)
